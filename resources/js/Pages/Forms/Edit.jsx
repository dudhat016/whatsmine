...
import { ArrowLeft, Trash2, ShieldCheck, FormInput, Sparkles } from 'lucide-react';
...
export default function FormsEdit({ form }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        type: form.type || 'embedded',
        fields: form.fields || ['email', 'first_name'],
        settings: {
            ...
            auto_tags: form.settings?.auto_tags || ['Website Lead'],
            custom_fields: form.settings?.custom_fields || [],
        },
        double_optin_enabled: form.double_optin_enabled ?? false,
        optin_channel: form.optin_channel || 'whatsapp',
        gdpr_checkbox: form.gdpr_checkbox ?? false,
        gdpr_text: form.gdpr_text || 'I agree to receive updates and promotional offers.',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('client.forms.update', form.id));
    };

    return (
        <ClientLayout title="Edit Subscription Form">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            Update form settings, custom fields, and Double OTP options.
                        </p>
                    </div>
                </div>
                            ...
                            <label className="flex items-start gap-3 cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <span className="text-xs text-gray-600 dark:text-gray-300">
                                        Sends a 6-digit OTP code before marking the contact as verified in CRM.
                                    </span>
                                </div>
                            </label>
