...
JS;
        ...
        $waUrlJson      = json_encode("https://wa.me/{$phone}?text={$msg}");
...
{$workingHoursCheck}
  ...
  var _agentInitial = {$agentInitJson};
  var _waUrl = {$waUrlJson};
  var _hasGreeting = _greeting !== '';
  ...
  var _bodyHtml = _hasGreeting
    ? '<div id="_wacw_tip_body"><div id="_wacw_tip_bubble">' + _escHtml(_greeting) + '</div>'
      + '<a id="_wacw_tip_cta" href="' + _escAttr(_waUrl) + '" target="_blank" rel="noopener noreferrer">Start Chat</a></div>'
    : '<div id="_wacw_tip_body"><a id="_wacw_tip_cta" href="' + _escAttr(_waUrl) + '" target="_blank" rel="noopener noreferrer">Start Chat on WhatsApp</a></div>';

  tooltip.innerHTML = '<div id="_wacw_tip_head">'
    + '<div id="_wacw_tip_avatar">' + _escHtml(_agentInitial) + '</div>'
    + '<div id="_wacw_tip_info">'
      + '<div id="_wacw_tip_name">' + _escHtml(_agentName) + '</div>'
