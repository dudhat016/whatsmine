import{r as $,j as d}from"./app-Ds9AwA9q.js";import{b as k,e as S,s as q}from"./cssCompiler-CLbkFpcE.js";import{C as z}from"./code-CEA5Zsr4.js";import{C}from"./check-tBw9yeg6.js";import{C as E}from"./copy-dTJVAlDl.js";import"./createLucideIcon-hLB6I6V7.js";const c=s=>{if(!s)return"";const r=q(s),e=`el-${r.id.replace(/[^a-zA-Z0-9-_]/g,"-")}`;if(r.type==="section"){const t=(r.elements||[]).map(a=>c(a)).join(`
`);return`<section id="${e}">
${t}
